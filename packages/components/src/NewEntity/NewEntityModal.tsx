...
const NewEntityModal: React.FC<NewEntityModalProps> = ({ children, ...rest }) => {
	return (
		<Modal bodyClassName='ee-new-entity-modal__body' className='ee-new-entity-modal' {...rest}>
			<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1440 320' className={'ee-new-entity-modal__wave'}>
