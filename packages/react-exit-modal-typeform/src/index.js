		...
		_createClass(ExitModal, [
			...
			},
			{
				...
				value: function render() {
					...
					var content = this.state.initialView
						? createElement(ExitModalOptions, {
...
ExitModal.defaultProps = {
	...
	typeFormUrl: '',
	introText:
		"We're sorry to see you go! Will you share feedback through a short survey to help us improve our product?",
