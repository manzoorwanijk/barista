...
const themeColorDesc = {
	primary:
		'The "primary" color is the color that is used most' +
		' frequently throughout the system. It utilizes the following css' +
		' variables:',
	secondary:
		'The "secondary" color is the second most used' +
		' color throughout the system. It utilizes the following css' +
		' variables:',
	accent:
		'The "accent" color is a contrasting color and is' +
		' intended to capture attention. It utilizes the following css' +
		' variables:',
	default: 'The "default" color group is used for most elements ' + ' and utilizes the following css variables:',
};

const defaultSizes = ['micro', 'tiny', 'smaller', 'small', 'default', 'big', 'bigger', 'huge', 'extreme'];

const defaultRadii = ['none', 'small', 'default', 'big', 'bigger', 'huge', 'full'];

const fontSizeDesc = {
	micro:
		'<p>Uh-oh... the fine print! This is where you hide all of the' +
		...
		' letters and words.</p>',
	tiny:
		'<p>Extremely anecdotal text of little importance. Should be used' +
	...
	smaller:
		'<p>Anything that is of far lesser importance than the default' +
	...
	small:
		'<p>Anything that is of slightly lesser importance than the default' +
	...
	default:
		'<p>The default priority that should make up the majority of text' + ' on a page, ie: the default text.</p>',
	big:
		'<p>A somewhat important heading that users should focus on before' +
		' reading default text. There can be lots of these on a page.</p>',
	bigger:
		'<p>A fairly important heading that users should focus on after' +
		...
		' color.</p>',
	huge:
		'<p>A very important heading that users should focus on second.' +
	...
	extreme:
		'<p>The highest priority heading on the screen that users should' +
