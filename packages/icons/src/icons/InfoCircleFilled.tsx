...
const SvgInfoCircleFilled = (props: IconProps): JSX.Element => {
	return (
		<svg viewBox='0 0 1024 1024' aria-hidden='true' fill='currentColor' height='1.25em' width='1.25em' {...props}>
...
export default withClassName(SvgInfoCircleFilled, 'info-circle-filled');
