...
const EditorOlRtl = (props: IconProps): JSX.Element => {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' className='ee-svg--editor-ol-rtl' {...props}>
...
export default withClassName(EditorOlRtl, 'editor-ol-rtl');
