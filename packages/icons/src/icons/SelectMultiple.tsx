...
const SvgSelectMultiple = (props: IconProps): JSX.Element => {
	return (
		<svg aria-hidden='true' fill='currentColor' height='1.25em' width='1.25em' viewBox='0 0 24 24' {...props}>
...
export default withClassName(SvgSelectMultiple, 'select-multiple');
