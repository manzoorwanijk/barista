...
const SvgChevronDoubleRight = (props: IconProps): JSX.Element => {
	return (
		<svg aria-hidden='true' fill='currentColor' height='1.25em' width='1.25em' viewBox='0 0 330 330' {...props}>
...
export default withClassName(SvgChevronDoubleRight, 'chevron-double-right');
