...
const SvgAppstoreFilled = (props: IconProps): JSX.Element => {
	return (
		<svg viewBox='64 64 896 896' fill='currentColor' aria-hidden='true' height='1.25em' width='1.25em' {...props}>
...
export default withClassName(SvgAppstoreFilled, 'appstore-filled');
