...
const SvgExclamationCircle = (props: IconProps): JSX.Element => {
	return (
		<svg aria-hidden='true' fill='currentColor' height='1.25em' width='1.25em' viewBox='0 0 1024 1024' {...props}>
...
export default withEnhance(SvgExclamationCircle);
