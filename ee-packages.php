 ...
 *
 * @package         Event Espresso Packages
 ...
 * Plugin Name: Event Espresso Packages
...
define('EE_PACKAGES_BASENAME', plugin_basename(__FILE__));

define('EE_PACKAGES_DIR', trailingslashit(plugin_dir_path(__FILE__)));

define('EE_PACKAGES_URL', trailingslashit(plugins_url('', __FILE__)));
